...
<body>
	...
	<div class="container">
		<h1>Edit <c:out value="${person.lastName}"></c:out>, il faut rajouter une verification metier sur l'id et surement d'autre truc tel que recuperer le nom du groupe</h1>
<br> injecter l'id du groupe aussi si on crée une nouvelle personne a partir d'un groupe
		<form:form method="POST" commandName="person">
			...
			<div class="form-group">
				...
				<form:input path="birthDate" class="form-control" type="date" pattern="dd/MM/yyyy"/>
